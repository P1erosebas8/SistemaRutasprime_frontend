...
// Importar la imagen desde la ruta de assets
import tarjetaPropiedadImage from '../assets/ejemplo-tarjeta-propiedad.jpg'; 

function SubirTarjetaPropiedad() {
  ...
  const handleFileChange = (event) => {
      ...
      if (file) {
          ...
          alert(`Documento de Tarjeta de Propiedad seleccionado: ${file.name}.`);
      }
  }
  ...
  return (
    <div className="container-fluid p-0 bg-white min-vh-100">
      ...
      <div className="container p-4" style={{ maxWidth: '600px' }}> 
        ...
        {/* Título */}
        <h2 className="mb-4 fw-bolder">Sube el documento de tarjeta de propiedad</h2>
        ...
        {/* Imagen del Documento (Simulación) */}
        <div className="text-center mb-5">
          <img 
            src={tarjetaPropiedadImage} 
            alt="Ejemplo de Tarjeta de Propiedad SUNARP"
...
export default SubirTarjetaPropiedad;
