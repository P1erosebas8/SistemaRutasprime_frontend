...
import { FaUsers, FaCarSide, FaUserShield, FaBuilding } from "react-icons/fa";
...
export default function DashBoardPrincipal() {
  ...
  const { loading, clientCount, clientDriverCount, adminSuperAdminCount, companyCount, loadDashboardData } = useDashboard();
  ...
  const dataDoughnut = {
    labels: ["Clientes", "Clientes-Conductores", "Admins-SuperAdmins", "Empresas"],
    datasets: [{
      data: [clientCount, clientDriverCount, adminSuperAdminCount, companyCount],
    ...
    >
      ...
      <section className="d-flex justify-content-center gap-4 flex-wrap mb-5">
        ...
        >
          ...
          <h3 className="mt-3 fw-bold">{clientCount}</h3>
          <p className="text-secondary">Clientes</p>
        </div>
        ...
        >
          ...
          <h3 className="mt-3 fw-bold">{clientDriverCount}</h3>
          <p className="text-secondary">Clientes-Conductores</p>
        </div>
        ...
        >
          ...
          <h3 className="mt-3 fw-bold">{adminSuperAdminCount}</h3>
          <p className="text-secondary">Admins-SuperAdmins</p>
        </div>
        ...
        >
          ...
          <h3 className="mt-3 fw-bold">{companyCount}</h3>
