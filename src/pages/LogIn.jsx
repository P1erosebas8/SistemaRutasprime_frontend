...
import FondoAuth2 from "../assets/FondosAuth2.jpg"
        ...
        <div className="container">
          ...
          <form className="mx-auto" style={{ maxWidth: "500px" }} onSubmit={handleSubmit}>
            ...
            <div className="text-center mt-3">
              <button type="button" className="btn btn-link text-info p-0" onClick={() => setShowReset(true)}>
            ...
            <div className="text-center mt-3">
              <button type="button" className="btn btn-link text-info p-0">
