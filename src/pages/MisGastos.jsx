...
function MisGastos() {
  ...
  useEffect(() => {
    const fetchHistorial = async () => {
      try {
        // Ejemplo del endpoint, puedes ajustarlo
  ...
  const gastoTotal = viajes.reduce((acc, v) => acc + v.costo, 0);
  ...
  return (
    <section style={{ paddingTop: "110px", minHeight: "100vh", background: "#141414" }}>
      <div className="container pb-5 text-white">
        ...
        <h1 className="text-start mb-5">Panel de Gastos</h1>
        ...
        <div className="row g-4">
          ...
          <div className="col-lg-8">
            <Card className="shadow bg-light text-dark">
              <Card.Header className="fw-bold fs-5">Historial de Viajes Pagados</Card.Header>
              <Card.Body>
          ...
          <div className="col-lg-4">
            <Card className="shadow bg-danger text-white text-center p-4">
              <h4 className="fw-bold mb-2">Gasto Total</h4>
              <h1 className="display-4 fw-bold">S/ {gastoTotal.toFixed(2)}</h1>
              <p>En todos tus viajes realizados</p>
            </Card>
          </div>
        </div>
      </div>
